...
export const CategoryGallery = ({idDate, linkCategory}: any) => {
  ...
  const startQuiz = () => linkCategory === 'art' ? linkTo('/art') : linkTo('/pic');
  ...
  return (
    ...
    <div className={style.box}>
      ...
      <div className={`${style.counter} ${style.none}`}>7/10</div>
        <div onClick={startQuiz}  className={`${style.pic_category} ${style.dark}`} style={containerStyle}>
