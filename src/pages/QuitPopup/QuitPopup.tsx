  ...
  return (
    ...
    <div className={`${style.quit} ${stateQuit ? style.active : ''}`}>
      <div className={style.quit_popup}>
        ...
        <p className={style.title}>Do you really want to quit the game?</p>
        <div className={style.btn_container}>
          <button onClick={() => setStateQuit(!stateQuit)} className={`${style.btn_popup} ${style.btn1}`}>Cancel</button>
          <button onClick={pathTo} className={`${style.btn_popup} ${style.btn2}`}>Yes</button>
