    ...
    <div>
      ...
      <div className={style.card_popup}>
        ...
        <div className={style.pic} style={containerStyle}>
          {/* <div className={style.circl right}></div>  */}
          <div className={`${style.circl} ${style.wrong}`}></div>
        </div>
        <p className={style.title}>Girl with a Pearl Earring</p>
        <p className={style.text}>Johannes Vermeer, 1665</p>
